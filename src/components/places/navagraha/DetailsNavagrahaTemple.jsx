...
export default function DetailsNavagrahaTemple() {
  ...
  return (
    <div id="profile-detail-container">
      ...
      <div>
        ...
        <p>
          <strong>Navagraha Order:</strong> {data.navagrahaOrder}
        </p>
        <p>
          <strong>Associated Graha:</strong> {data.associatedGraha}
        </p>
        <p>
      ...
      {GetUserId() === data.userId && (
        <div style={{ margin: "20px" }}>
          <Link to={`/place/navagraha/update/${id}`}>
