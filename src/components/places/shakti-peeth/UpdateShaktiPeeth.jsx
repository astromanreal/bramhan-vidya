  ...
  return (
    <>
      <form id="add-profile-form" onSubmit={handleSubmit}>
        ...
        <div>
          <label>Goddess Form:</label>
          <input
            type="text"
            name="goddessForm"
            value={formData.goddessForm}
            onChange={handleChange}
          />
        </div>
        <div>
          <label>Shakti Peeth Type:</label>
          <select
            required
            name="shaktiPeethType"
            value={formData.shaktiPeethType}
            onChange={handleChange}
          >
            <option value="">Select Type</option>
            <option value="Maha Shakti Peeth">Maha Shakti Peeth</option>
        ...
        <button type="submit" disabled={loading}>
          {loading ? "Updating..." : "Update Shakti Peeth"}
        </button>
      </form>
    </>
  );
