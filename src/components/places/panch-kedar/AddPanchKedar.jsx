  ...
  return (
    <>
      <form id="add-profile-form" onSubmit={handleSubmit}>
        ...
        <div>
          <label>Kedar Order:</label>
          <select
            required
            name="kedarOrder"
            value={formData.kedarOrder}
            onChange={handleChange}
          >
        ...
        <div>
          <label>Associated Pandava:</label>
          <select
            required
            name="associatedPandava"
            value={formData.associatedPandava}
            onChange={handleChange}
          >
            <option value="">Select Pandava</option>
        ...
        <div>
          <label>Associated Shiva Form:</label>
          <input
            type="text"
            name="associatedShivaForm"
            value={formData.associatedShivaForm}
            onChange={handleChange}
          />
        </div>
        <div>
        ...
        <button type="submit" disabled={loading}>
          {loading ? "Adding..." : "Add Panch Kedar"}
        </button>
      </form>
    </>
  );
