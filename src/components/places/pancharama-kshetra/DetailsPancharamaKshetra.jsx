  ...
  return (
    <div id="profile-detail-container">
      ...
      <div>
        ...
        <p>
          <strong>Kshetra Name:</strong> {data.kshetraName}
        </p>
        <p>
        ...
        <p>
          <strong>Kshetra Order:</strong> {data.kshetraOrder}
        </p>
        <p>
          <strong>Associated Lingam:</strong> {data.associatedLingam}
        </p>
        <p>
          <strong>Associated Theertham:</strong> {data.associatedTheertham}
        </p>
        <p>
      ...
      {GetUserId() === data.userId && (
        <div style={{ margin: "20px" }}>
          <Link to={`/place/pancharama-kshetra/update/${id}`}>
